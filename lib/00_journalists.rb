...
def questions
    puts "\n1 : Combien d'entités disponibles dans la liste ?"
    puts "2 : Quelle est l'entité la plus courte ?"
    puts "3 : Combien d'entités comportant 5 caractères ?"
    puts "4 : Combien d'entités commençant par une majuscule ?"
    puts "5 : Trier la liste par ordre alphabétique ?"
    puts "6 : Trier la liste par nombre de caractères ?"
    puts "7 : Quelle est la position de @epenser dans cette liste ?"
    puts "8 : Répartir les entités par taille ?"
